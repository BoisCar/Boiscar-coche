...
public abstract class MapsJava {
    ...
    protected static void storageRequest(String urlRequest,String info,String status,
            Exception exception){
        Date date = new Date();
        numRequest+=1;
        MapsJava.stockRequest=(String[][])(resizeArray(MapsJava.stockRequest,numRequest));
    ...
    protected String getSelectPropertiesRequest(){
        return "&region=" + MapsJava.region + "&language=" + MapsJava.language + 
                "&sensor=" + MapsJava.sensor+ "&key=" + MapsJava.APIKey;
    }
