...
public class Route extends MapsJava{
    ...
    private final String URLRoot="https://maps.googleapis.com/maps/api/directions/xml";
    ...
    public URL createURL(String originAddress, String destinationAddress, ArrayList<String> waypoints,
